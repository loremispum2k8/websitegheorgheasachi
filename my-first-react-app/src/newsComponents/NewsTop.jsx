            ...
            <div className='newsTopContent'>
                ...
                <div className='new news1'>
                    ...
                    <div className='news1Content'>
                        <h1 className='newsTitles news1Title'>Competiție internațională pentru pasionații de engleză</h1>
                ...
                <div className='new news2 news23'>
                    ...
                    <div className='smallNewsContent'>
                        <h1 className='newsTitles news23Title'>Călătoria pâinii văzută prin ochi de copii</h1>
                ...
                <div className='new news3 news23'>
                    ...
                    <div className="smallNewsContent">
                        <h1 className='newsTitles news23Title'>Celebrând diversitatea în ziua internațională a autismului</h1>
                        <div className='news23Info'>
                ...
                <div className='mediumNewsContainer'>
                    <div className='new news4 news45'>
                        ...
                        <div className="mediumNewsContent">
                            <h1 className='newsTitles news45Title'>Elevii clasei a X-a B învăță primul ajutor</h1>
                    ...
                    <div className='new news5 news45'>
                        <div className='newsTitles newsImage'><img src="https://i.imgur.com/9M0Nk06.png" alt="" /></div>
                        <div className="mediumNewsContent">
                            <h1 className='newsTitles news45Title'>Întâlnirea cu absolvenții 2025 „Gala Asachi: Reflectoare, Cameră, Reuniune!”</h1>
