    ...
    return(
        <div className='historyContainer'>
            ...
            <div className='historyContentGrid'>
                ...
                <p className='historyTextOne'>
                    <span>În anul 1991, în or. Ungheni, a fost dată în exploatare şcoala care poartă numele iluministului Gheorghe Asachi.</span>
                    Au fost înscrişi 991 elevi, coordonaţi de 75 cadre didactice. În anul 1998, şcoala a primit statutul de liceu teoretic. Mai târziu,în anul 2013 Liceul Teoretic “Gheorghe Asachi” devine instituţie publică. Clădirea liceului este amplasată în cartierul Tineretului, mun. Ungheni.
                </p>

                <p className='historyTextTwo'>
                    Această clădire are o capacitate de 1276 elevi, cu o infrastructură alcătuită din 48 de cabinete,  2 săli de sport, sală specializată de şah. Centru de Resurse pentru educaţie incluzivă, bibliotecă şcolară, cantină şcolară, sală pentru festivităţi.
                    <span>Sălile de clasă sunt dotate cu mobilierul necesar şi o serie de materiale didactice...</span>
                </p>
