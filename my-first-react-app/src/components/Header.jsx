    ...
    return(
        <div id={id} className='headerContainer'>
            <div className='headerImagesContainer'>
                <img ref={img1} id='header1' className='headerImage showHeader' src="https://i.imgur.com/s4Ojgvp.jpeg" alt="" />
                <img ref={img2} id='header2' className='headerImage' src="https://i.imgur.com/iMLxrRL.jpeg" alt="" />
                <img ref={img3} id='header3' className='headerImage' src="https://i.imgur.com/USsZdmZ.jpeg" alt="" />
            </div>
